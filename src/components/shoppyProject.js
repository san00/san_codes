...
function ShoppyProject() {
  ...
  return (
    <AppDetail to="/shoppyApp/">
      ...
      <InnerWrapper>
        <Header>Shoppy e-commerce app</Header>
        <Text>
          Add items to the cart, then check out and pay for drinks using the e-store.
          The app uses a headless CMS to edit and manage content and uses
          GraphQL to consume the API.
        </Text>
        <Text>Strapi, React, GraphQL, Stripe, MongoDB.</Text>
        ...
        <IconWrapper>
          <Github href="https://github.com/san00/online-store">
            <svg
              ...
              viewBox="0 0 24 24"
            >
              <title>See code on github</title>
