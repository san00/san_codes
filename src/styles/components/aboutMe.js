...
export const Wrap = styled.section`
  ...
  margin-left: ${spacingScale.spacing_s};
  margin-right: ${spacingScale.spacing_s};
  @media (min-width: ${mediaQuery.breakpoint1}) {
...
`
export const Bckgrnd = styled.section`
  display: flex;
